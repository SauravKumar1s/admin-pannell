...
const colors = ["#0039a6", "#0039a6"]; // Specify colors for each segment
  ...
  return (
    <div className="sm:px-8">
      ...
      <div className="mt-5 grid grid-cols-1 gap-5 md:grid-cols-2 xl:flex justify-between">
        ...
        <div className="xl:w-[600px] flex flex-col border border-gray-300 shadow-sm rounded-2xl">
          <h6 className="sm:text-2xl text-sm text-start p-2">Car Models</h6>
          <div className="flex flex-col justify-center items-center">
            <div className="relative sm:left-4  top-6 flex justify-center items-center">
              <DonutChart
                width={350}
                height={300}
                data={reactDonutChartdata}
                colors={colors} // Specify the colors array
