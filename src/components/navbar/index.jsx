...
const Navbar = (props) => {
  ...
  return (
    <nav className="sticky top-0 z-40 flex flex-row  items-center justify-between rounded-xl bg-white/10 p-2 backdrop-blur-xl dark:bg-[#0b14374d]  border-b-2 ">
        ...
        <Dropdown
          button={
            <p className="cursor-pointer">
              <IoMdNotificationsOutline className="h-6 w-8 text-gray-600 dark:text-white" />
            </p>
          }
